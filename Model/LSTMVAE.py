...
# https://github.com/chickenbestlover/RNN-Time-series-Anomaly-Detection/blob/master/model/model.py
class RNNPredictor(nn.Module):
    """Container module with an encoder, a recurrent module, and a decoder."""

    def __init__(self, rnn_type, enc_inp_size, rnn_inp_size, rnn_hid_size=64, 
